...
class EyeTracker:
    ...
    def process_frame(self, frame):
        ...
        data = {'face_detected': False, 'gaze_x': 0.5, 'gaze_y': 0.5, 'gaze_horizontal': 'centro', 
                'gaze_vertical': 'centro', 'avg_ear': 0.0, 'blink_detected': False, 
                'total_blinks': self.blink_total, 'saccade_distance': 0.0}
        ...
        data['gaze_horizontal'] = 'destra' if ax < 0.4 else 'sinistra' if ax > 0.6 else 'centro'
        data['gaze_vertical'] = 'su' if ay < 0.4 else 'giù' if ay > 0.6 else 'centro'
